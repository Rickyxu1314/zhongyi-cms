...
<div id="content">
	<div class="nd">
		<div class="nd_title"><strong>添加品牌合作</strong></div>
		<?php echo form_open_multipart("index.php/admin/cooperate/cooperate_add")?>
		<table>
			<tr>
				<td width="10%">品牌合作名称:</td>
				<td width="80%"><input type="text" class="input" name="cooperate_name" /></td>
			</tr>
			<tr>
