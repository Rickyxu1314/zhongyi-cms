...
<div id="content">
	<div class="nl">
		<div class="nl_title"><strong>认证列表</strong></div>
		<table>
			<thead>
				<tr>
					<th width="5%">序号</th>
			...
			<?php if($arr){?>
				...
				<tr>
	                ...
	                <td><img alt="<?php echo $value->title?>" src="<?php echo '/uploads/credentials/thumbs/'.$value->img?>" /></td>
	                <td><?php echo $value->title?></td>
	                <td><?php echo $value->content?></td>
	                <td><?php echo $value->addtime?></td>
	                <td style="border-right:none;">
		                <a href="credentials/credentials_edit/<?php echo $value->id?>">修改</a>
		                <a href="credentials/credentials_delete/<?php echo $value->id?>">删除</a>
	                </td>
				</tr>
				<?php }?>
			<?php }else{?>
