...
<div id="content">
	<div class="nd">
		<div class="nd_title"><strong>修改资质认证</strong></div>
		<?php echo form_open_multipart("index.php/admin/credentials/credentials_edit")?>
                <input type="hidden" name="id" value="<?php echo $arr['id']?>" />
		<table>
			<tr>
				<td width="10%">资质认证名称:</td>
				<td width="80%"><input type="text" class="input" value="<?php echo $arr['title']?>" name="credentials_name" /></td>
			</tr>
			<tr>
				<td width="10%">资质认证图片</td>
				<td width="80%">
                                    <img src="<?php echo '/uploads/credentials/thumbs/'.$arr['img']?>" alt="<?php echo $arr['title']?>" style="float:left;" />
