...
<div id="content">
	<div class="nd">
		<div class="nd_title"><strong>添加荣誉证书</strong></div>
		<?php echo form_open_multipart("index.php/admin/honor/honor_add")?>
		<table>
			<tr>
				<td width="10%">荣誉证书名称:</td>
				<td width="80%"><input type="text" class="input" name="honor_name" /></td>
			</tr>
			<tr>
				<td width="10%">荣誉证书图片</td>
				<td width="80%">
