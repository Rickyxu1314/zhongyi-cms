...
<div id="content">
	<div class="nd">
		<div class="nd_title"><strong>修改品牌合作</strong></div>
		<?php echo form_open_multipart("index.php/admin/cooperate/cooperate_edit")?>
                <input type="hidden" name="id" value="<?php echo $arr['id']?>" />
		<table>
			<tr>
				<td width="10%">品牌合作名称:</td>
				<td width="80%"><input type="text" class="input" value="<?php echo $arr['title']?>" name="cooperate_name" /></td>
			</tr>
			<tr>
				<td width="10%">品牌合作图片</td>
				<td width="80%">
                                    <img src="<?php echo '/uploads/cooperate/thumbs/'.$arr['img']?>" alt="<?php echo $arr['title']?>" style="float:left;" />
