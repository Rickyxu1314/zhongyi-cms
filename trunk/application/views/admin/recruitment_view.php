...
<div id="content">
	<div class="nl">
		<div class="nl_title"><strong>人才招聘</strong></div>
		<table>
			<thead>
				<tr>
					<th width="5%">序号</th>
			...
			<?php if($arr){?>
				...
				<tr>
					...
					<td style="border-right:none;">
						<a href="recruitment/recruitment_edit/<?php echo $value->id?>">修改</a>
						<!--<a href="recruitment/recruitment_delete/<?php echo $value->id?>">删除</a>-->
					</td>
				</tr>
				<?php }?>
			<?php }else{?>
				<tr>
					<td colspan="4" style="font-size:20px;"><strong>暂无招聘信息</strong></td>
				</tr>
			<?php }?>
			</tbody>
		</table>
