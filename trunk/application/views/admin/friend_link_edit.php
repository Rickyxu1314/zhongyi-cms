...
<div id="content">
	<div class="nd">
		<div class="nd_title"><div><strong>修改友情链接</strong></div><div><a class="add" href="javascript:void(0)">添加</a></div></div>
		<?php echo form_open('index.php/admin/friend_link/friend_link_edit','name=form')?>
		<table style="border:none;">
			...
			<tbody>
				<tr class="link">
					...
					<td style="border-top:none;"><input type="text" name="link_name" class="input_title" value="<?php echo $arr['link_name']?>" /></td>
					<td style="border-top:none;"><input type="text" name="url" class="input_title" value="<?php echo $arr['url']?>" /></td>
				</tr>
			</tbody>
			<tfoot>
				<tr>
