...
<div id="content">
	<div class="nd">
		<div class="nd_title"><strong>添加案例</strong></div>
		<?php echo form_open_multipart("index.php/admin/cases/cases_add")?>
		<table>
			<tr>
				<td width="10%">案例名称:</td>
				<td width="80%"><input type="text" class="input" name="cases_name" /></td>
			</tr>
			<tr>
				<td width="10%">案例图片</td>
				<td width="80%">
