...
<div id="content">
	<div class="nd">
		<div class="nd_title"><strong>修改招聘信息</strong></div>
		<?php echo form_open('index.php/admin/recruitment/recruitment_edit','name=form')?>
		<table style="border:none;">
			<tbody>
				...
				<tr>
					...
					<td style="padding-right:5px;"><span id="editor"></span><input type="hidden" value="" id="value" name="content" />
					<input type="hidden" value="<?php echo $this->uri->segment(4)?>" id="id" name="id" /></td>
				</tr>
			</tbody>
			<tfoot>
				<tr>
