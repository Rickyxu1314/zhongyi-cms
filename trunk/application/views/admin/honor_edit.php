...
<div id="content">
	<div class="nd">
		...
		<?php echo form_open_multipart("index.php/admin/honor/honor_edit")?>
                <input type="hidden" name="id" value="<?php echo $arr['id']?>" />
		<table>
			<tr>
				<td width="10%">案例名称:</td>
				<td width="80%"><input type="text" class="input" value="<?php echo $arr['title']?>" name="honor_name" /></td>
			</tr>
			<tr>
				<td width="10%">案例图片</td>
				<td width="80%">
                                    <img src="<?php echo '/uploads/honor/thumbs/'.$arr['img']?>" alt="<?php echo $arr['title']?>" style="float:left;" />
